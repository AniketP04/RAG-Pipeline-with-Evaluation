"""Script to build and test hybrid search indices.

Creates vector and keyword search indices from processed chunks.
Tests the hybrid search functionality with sample queries.
"""
